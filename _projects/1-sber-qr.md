...
Чтобы научить людей пользоваться QR-кодами, Сбербанк придумал геймифицированный продукт по типу «Ingress» и «Pokemon Go». С его помощью можно взаимодействовать с реальными